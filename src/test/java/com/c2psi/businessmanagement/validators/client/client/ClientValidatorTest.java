...
public class ClientValidatorTest {
    ...
    public void validate() {
        ClientDto clientDto = ClientDto.builder()
                .clientCaDto(ClientCashAccountDto.builder().build())
                .clientCni("fdfdfdfd")
                .clientName("dsdfdfdf")
                .clientOthername("dfdsfdfd")
                .clientPosId(PointofsaleDto.builder().build().getId())
                .clientAddressDto(AddressDto.builder()
