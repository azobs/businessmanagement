...
public class ClientCashAccountServiceImpl implements ClientCashAccountService {
    ...
    @Override
    public Boolean saveCashOperation(ClientCashAccountDto clientCashAccountDto,
                                     ClientCashOperationDto clientCashOperationDto) {
        Long ccaId = clientCashAccountDto.getId();
        BigDecimal amount = clientCashOperationDto.getCcoAmountinmvt();
        Long userbmId = clientCashOperationDto.getCcoUserbmDto().getId();
        OperationType operationType = clientCashOperationDto.getCcoOperationDto().getOpType();
        String opObject = clientCashOperationDto.getCcoOperationDto().getOpObject();
        String opDescription = clientCashOperationDto.getCcoOperationDto().getOpDescription();
        /***************************************************************************************
         * Il faut se rassurer que les parametres sensible de l'operation ne sont pas null
         */
        if(ccaId == null || amount == null || userbmId == null || operationType == null){
    ...
    @Override
    public Boolean saveCashOperation(ClientCashOperationDto clientCashOperationDto) {
        Long ccaId = clientCashOperationDto.getCcoCltCashAccountDto().getId();
        BigDecimal amount = clientCashOperationDto.getCcoAmountinmvt();
        Long userbmId = clientCashOperationDto.getCcoUserbmDto().getId();
        OperationType operationType = clientCashOperationDto.getCcoOperationDto().getOpType();
        String opObject = clientCashOperationDto.getCcoOperationDto().getOpObject();
