...
public class DiversCashAccountServiceImpl implements DiversCashAccountService {
    ...
    @Override
    public Boolean saveCashOperation(DiversCashOperationDto diversCashOperationDto) {
        Long dcaId = diversCashOperationDto.getDcoDiversCashAccountDto().getId();
        BigDecimal amount = diversCashOperationDto.getDcoAmountinmvt();
        Long userbmId = diversCashOperationDto.getDcoUserbmDto().getId();
        OperationType operationType = diversCashOperationDto.getDcoOperationDto().getOpType();
        String opObject = diversCashOperationDto.getDcoOperationDto().getOpObject();
    ...
    @Override
    public DiversCashAccountDto findDiversCashAccountofPosIfExistOrCreate(Long posId) {
        /******************************************************
         ...
         */
        Optional<DiversCashAccount> optionalDiversCashAccountofPos = diversCashAccountRepository.
                findDiversCashAccountByAndDiverscashPosId(posId);
        if(!optionalDiversCashAccountofPos.isPresent()){
            /****************************
             * Ici on doit creer le compte cash des divers pour le pointofsale indique
             * car aucun n'existe donc en fait c'est lors de la creation de la premiere
             * operation sur un compte divers que ceci survient
             */
        ...
        //DiversCashAccount diversCashAccountofPos = optionalDiversCashAccountofPos.get();

        /******
         * Ici on est sur qu'il existe un compte cash pour les divers du pointofsale indique
         */
        return DiversCashAccountDto.fromEntity(optionalDiversCashAccountofPos.get());
    }
}
