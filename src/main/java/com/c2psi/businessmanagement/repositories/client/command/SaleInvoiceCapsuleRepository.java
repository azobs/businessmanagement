...
public interface SaleInvoiceCapsuleRepository
    ...
    @Query("SELECT saleicaps FROM SaleInvoiceCapsule saleicaps WHERE saleicaps.saleicapsCode=:saleicapsCode AND saleicaps.saleicapsPosId=:posId")
    ...
    @Query("SELECT saleicaps FROM SaleInvoiceCapsule saleicaps WHERE saleicaps.saleicapsPosId=:posId AND (saleicaps.saleicapsInvoicingDate>=:startDate AND saleicaps.saleicapsInvoicingDate<=:endDate) ORDER BY saleicaps.saleicapsClient.clientName ASC")
    ...
    @Query("SELECT saleicaps FROM SaleInvoiceCapsule saleicaps WHERE saleicaps.saleicapsUserbm.id=:userbmId AND saleicaps.saleicapsPosId=:posId AND (saleicaps.saleicapsInvoicingDate>=:startDate AND saleicaps.saleicapsInvoicingDate<=:endDate) ORDER BY saleicaps.saleicapsClient.clientName ASC")
    ...
    @Query("SELECT saleicaps FROM SaleInvoiceCapsule saleicaps WHERE saleicaps.saleicapsClient.id=:clientId AND saleicaps.saleicapsPosId=:posId AND (saleicaps.saleicapsInvoicingDate>=:startDate AND saleicaps.saleicapsInvoicingDate<=:endDate) ORDER BY saleicaps.saleicapsClient.clientName ASC")
    ...
    @Query("SELECT saleicaps FROM SaleInvoiceCapsule saleicaps WHERE saleicaps.saleicapsClient.id=:clientId AND saleicaps.saleicapsUserbm.id=:userbmId AND saleicaps.saleicapsPosId=:posId AND (saleicaps.saleicapsInvoicingDate>=:startDate AND saleicaps.saleicapsInvoicingDate<=:endDate) ORDER BY saleicaps.saleicapsClient.clientName ASC")
