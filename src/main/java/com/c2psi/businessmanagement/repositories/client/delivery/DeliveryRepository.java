...
public interface DeliveryRepository extends JpaRepository<Delivery, Long> {
    ...
    @Query("SELECT delivery FROM Delivery delivery WHERE delivery.deliveryCode=:deliveryCode AND delivery.deliveryPosId=:posId")
    ...
    @Query("SELECT delivery FROM Delivery delivery WHERE delivery.deliveryPosId=:posId AND (delivery.deliveryDate>=:startDate AND delivery.deliveryDate<=:endDate) ORDER BY delivery.creationDate ASC")
    ...
    @Query("SELECT delivery FROM Delivery delivery WHERE delivery.deliveryPosId=:posId AND delivery.deliveryState=:deliveryState AND (delivery.deliveryDate>=:startDate AND delivery.deliveryDate<=:endDate) ORDER BY delivery.creationDate ASC")
    ...
    @Query("SELECT delivery FROM Delivery delivery WHERE delivery.deliveryPosId=:posId AND delivery.deliveryUserbm.id=:userbmId AND (delivery.deliveryDate>=:startDate AND delivery.deliveryDate<=:endDate) ORDER BY delivery.creationDate ASC")
    ...
    @Query("SELECT delivery FROM Delivery delivery WHERE delivery.deliveryPosId=:posId AND delivery.deliveryUserbm.id=:userbmId AND delivery.deliveryState=:deliveryState AND (delivery.deliveryDate>=:startDate AND delivery.deliveryDate<=:endDate) ORDER BY delivery.creationDate ASC")
