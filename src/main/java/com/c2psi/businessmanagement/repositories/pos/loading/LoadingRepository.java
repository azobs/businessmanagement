...
public interface LoadingRepository extends JpaRepository<Loading, Long> {
    ...
    @Query("SELECT loading FROM Loading  loading WHERE loading.loadCode=:loadingCode AND loading.loadPosId=:posId")
    ...
    @Query("SELECT loading FROM Loading  loading WHERE loading.loadPosId=:posId AND (loading.loadDate>=:startDate AND loading.loadDate<=:endDate) ORDER BY loading.loadDate ASC, loading.loadCode ASC")
    ...
    @Query("SELECT loading FROM Loading  loading WHERE loading.loadPosId=:posId AND loading.loadUserbmManager.id=:userbmmanagerId AND (loading.loadDate>=:startDate AND loading.loadDate<=:endDate) ORDER BY loading.loadDate ASC, loading.loadCode ASC")
    ...
    @Query("SELECT loading FROM Loading  loading WHERE loading.loadPosId=:posId AND loading.loadUserbmSaler.id=:userbmsalerId AND (loading.loadDate>=:startDate AND loading.loadDate<=:endDate) ORDER BY loading.loadDate ASC, loading.loadCode ASC")
    ...
    @Query("SELECT loading FROM Loading  loading WHERE loading.loadPosId=:posId AND loading.loadUserbmManager.id=:userbmmanagerId AND loading.loadUserbmSaler.id=:userbmsalerId AND (loading.loadDate>=:startDate AND loading.loadDate<=:endDate) ORDER BY loading.loadDate ASC, loading.loadCode ASC")
