...
public interface FormatRepository extends JpaRepository<Format, Long> {
    ...
    @Query("SELECT f FROM Format f WHERE f.formatPos.id=:posId ")
    ...
    @Query("SELECT f FROM Format f WHERE f.formatName=:formatName AND f.formatCapacity=:formatCapacity AND f.formatPos.id=:posId")
