...
public interface SupplyInvoiceDamageRepository extends JpaRepository<SupplyInvoiceDamage, Long> {
    ...
    @Query("SELECT sidam FROM SupplyInvoiceDamage sidam WHERE sidam.sidamCode=:sidamCode AND sidam.sidamPos.id=:posId")
     ...
     */
    @Query("SELECT sidam FROM SupplyInvoiceDamage sidam WHERE sidam.sidamPos.id=:posId AND (sidam.sidamInvoicingDate>=:startDate AND sidam.sidamInvoicingDate<=:endDate) ORDER BY sidam.sidamDeliveryDate ASC, sidam.sidamCode ASC")
   ...
   (posId, userbmId, date)
    */
    @Query("SELECT sidam FROM SupplyInvoiceDamage sidam WHERE sidam.sidamPos.id=:posId AND sidam.sidamUserbm.id=:userbmId AND (sidam.sidamInvoicingDate>=:startDate AND sidam.sidamInvoicingDate<=:endDate) ORDER BY sidam.sidamDeliveryDate ASC, sidam.sidamCode ASC")
     ...
     */
    @Query("SELECT sidam FROM SupplyInvoiceDamage sidam WHERE sidam.sidamPos.id=:posId AND sidam.sidamProvider.id=:providerId AND (sidam.sidamInvoicingDate>=:startDate AND sidam.sidamInvoicingDate<=:endDate) ORDER BY sidam.sidamDeliveryDate ASC, sidam.sidamCode ASC")
     ...
     */
    @Query("SELECT sidam FROM SupplyInvoiceDamage sidam WHERE sidam.sidamPos.id=:posId AND sidam.sidamProvider.id=:providerId AND sidam.sidamUserbm.id=:userbmId AND (sidam.sidamInvoicingDate>=:startDate AND sidam.sidamInvoicingDate<=:endDate) ORDER BY sidam.sidamDeliveryDate ASC, sidam.sidamCode ASC")
