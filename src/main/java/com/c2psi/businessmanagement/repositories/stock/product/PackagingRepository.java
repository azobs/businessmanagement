...
public interface PackagingRepository extends JpaRepository<Packaging, Long> {
    ...
    @Query("SELECT pack FROM Packaging pack WHERE pack.packPos.id=:posId AND pack.packProvider.id=:providerId AND pack.packFirstcolor=:packFirstcolor AND pack.packLabel=:packLabel")
    ...
    @Query("SELECT pack FROM Packaging pack WHERE pack.packPos.id=:posId")
    ...
    @Query("SELECT pack FROM Packaging pack WHERE pack.packProvider.id=:providerId AND pack.packPos.id=:posId")
