...
public interface SupplyInvoiceCashRepository
    ...
    @Query("SELECT sicash FROM SupplyInvoiceCash sicash WHERE sicash.sicashCode=:sicashCode AND sicash.sicashPos.id=:posId")
     ...
     */
    @Query("SELECT sicash FROM SupplyInvoiceCash sicash WHERE sicash.sicashPos.id=:posId AND (sicash.sicashInvoicingDate>=:startDate AND sicash.sicashInvoicingDate<=:endDate) ORDER BY sicash.sicashDeliveryDate ASC, sicash.sicashCode ASC")
    ...
    (posId, userbmId, date)
     */
    @Query("SELECT sicash FROM SupplyInvoiceCash sicash WHERE sicash.sicashPos.id=:posId AND sicash.sicashUserbm.id=:userbmId AND (sicash.sicashInvoicingDate>=:startDate AND sicash.sicashInvoicingDate<=:endDate) ORDER BY sicash.sicashDeliveryDate ASC, sicash.sicashCode ASC")
     ...
     */
    @Query("SELECT sicash FROM SupplyInvoiceCash sicash WHERE sicash.sicashPos.id=:posId AND sicash.sicashProvider.id=:providerId AND (sicash.sicashInvoicingDate>=:startDate AND sicash.sicashInvoicingDate<=:endDate) ORDER BY sicash.sicashDeliveryDate ASC, sicash.sicashCode ASC")
     ...
     */
    @Query("SELECT sicash FROM SupplyInvoiceCash sicash WHERE sicash.sicashPos.id=:posId AND sicash.sicashProvider.id=:providerId AND sicash.sicashUserbm.id=:userbmId AND (sicash.sicashInvoicingDate>=:startDate AND sicash.sicashInvoicingDate<=:endDate) ORDER BY sicash.sicashDeliveryDate ASC, sicash.sicashCode ASC")
